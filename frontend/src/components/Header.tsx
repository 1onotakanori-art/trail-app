...
export default function Header({ onSearch, onQuickAdd }: Props) {
            ...
            <div style={styles.notifDropdown}>
              ...
              <div style={{ maxHeight: '400px', overflowY: 'auto' }}>
                {notifications.length === 0
                  ...
                  : notifications.map((n) => (
                      <div key={n.id} style={{ ...styles.notifItem, background: n.read ? '#fff' : '#f3f8ff' }}>
        ...
        <div style={{ position: 'relative' }}>
          ...
          {showUserMenu && (
            <div style={styles.dropdown}>
              ...
              <button style={styles.dropdownButton} onClick={logout}>ログアウト</button>
            </div>
          )}
        </div>
      </div>
...
const styles: Record<string, React.CSSProperties> = {
  ...
  dropdownButton: { width: '100%', textAlign: 'left', background: 'none', border: 'none', padding: '12px 16px', fontSize: '14px', color: '#d32f2f', cursor: 'pointer' },
